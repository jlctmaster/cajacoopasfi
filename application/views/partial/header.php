...
<head>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		...
		<link rel="stylesheet" type="text/css" href="css/iomsystem.css"/>
		<link rel="stylesheet" type="text/css" href="css/iomsystem_print.css"/>
		...
		<script src="bower_components/multiselect-two-sides/dist/js/multiselect.min.js"></script>
		<!-- endbower -->
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="dist/iomsystem.min.css?rel=c729835075"/>
		<!-- end mincss template tags -->
		<!-- start minjs template tags -->
		<script type="text/javascript" src="dist/iomsystem.min.js?rel=aaf585bba7"></script>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-right" style="margin:0">
					<?php echo anchor('home/change_password/'.$user_info->person_id, $user_info->first_name . ' ' . $user_info->last_name, array('class' => 'modal-dlg', 'data-btn-submit' => $this->lang->line('common_submit'), 'title' => $this->lang->line('users_change_password'))); ?>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">SysGeC COOPAFSI</a>
				</div>
