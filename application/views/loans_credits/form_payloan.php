...
<?php echo form_open('loans_credits/payment_loan/'.$loan_info->loan_id, array('id'=>'loan_pay_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="loans">
			...
			<div class='col-xs-8'>
				<div class="input-group">
					...
					<?php echo form_input(array(
							...
							'class'=>'form-control input-sm',
							'type' => 'text',
							'value'=>to_date(strtotime($loan_info->paydate)))
							); ?>
				</div>
			</div>
		</div>
...
$(document).ready(function()
{
	...
	$('#paytype').change(function(){
		...
		{
			let loan_id = "<?php echo $loan_info->loan_id;?>";
			$.ajax({
				type: 'GET',
				url: "<?php echo site_url('loans_credits/get_balance/l/"+loan_id+"/"+$(this).val()+"'); ?>",
				dataType: 'json',
