...
<?php echo form_open('items/save/'.$item_info->item_id, array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('items_uom'), 'uom', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_dropdown('uom_id', $uom, $selected_uom, array('class'=>'form-control')); ?>
			</div>
		</div>
...
$(document).ready(function()
{
	...
	$("#mark").autocomplete({
		source: "<?php echo site_url('items/suggest_mark');?>",
		delay: 10,
		appendTo: '.modal-content'
	});
