	...
	<fieldset id="cash_concepts">
		...
		<div class="form-group form-group-sm" id="cash_concept_parent_display" style="display:none;">
			...
			<div class='col-xs-8'>
				...
				<input type="hidden" name="hide_code" id="hide_code" value="01-">
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			<input type="hidden" name="concept_type" value="1">
			...
			<div class='col-xs-8'>
				<?php echo form_input(array(
						...
						'value'=>(!empty($cash_concept_info->code) ? $cash_concept_info->code : "01-"))
						);?>
			</div>
		</div>
   	...
   	$('#cash_concept_parent_id').change(function(){
   		...
   		$.ajax({
			...
			success: function(resp){
				$('#hide_code').val((resp.code.length == 0 ? "01-" : resp.code+"-"));
				$('#code').val((resp.code.length == 0) ? "01-" : resp.code+"-");
	        },
