	...
	<fieldset id="cash_concepts">
		...
		<div class="form-group form-group-sm" id="cash_concept_parent_display" style="display:none;">
			...
			<div class='col-xs-8'>
				...
				<input type="hidden" name="hide_code" id="hide_code" value="02-">
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-8'>
				<?php echo form_input(array(
						...
						'value'=>(!empty($cash_concept_info->code) ? $cash_concept_info->code : "02-"))
						);?>
			</div>
		</div>
   	...
   	$('#cash_concept_parent_id').change(function(){
   		...
   		$.ajax({
			...
			success: function(resp){
				$('#hide_code').val((resp.code.length == 0 ? "02-" : resp.code+"-"));
				$('#code').val((resp.code.length == 0 ? "02-" : resp.code+"-"));
	        },
