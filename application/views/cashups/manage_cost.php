...
$(document).ready(function()
{
	...
	'use strict';
		...
		$.fn.bootstrapTable.locales['<?php echo current_language_code(); ?>'] = {
			...
			formatNoMatches: function () {
				return "<?php echo $this->lang->line('costs_no_cost_to_display'); ?>";
			},
	...
	table_support.init({
		resource: '<?php echo site_url($controller_name."/search_cost");?>',
...
<div id="page_title"><?php echo $this->lang->line("costs_info"); ?><br>
	<?php echo anchor('cashups', $this->lang->line('common_back')); ?></div>

<div id="title_bar" class="btn-toolbar">
	<button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name."/view_cost"); ?>'
			title='<?php echo $this->lang->line('costs_new'); ?>'>
		<span class="glyphicon glyphicon-plus">&nbsp</span><?php echo $this->lang->line('costs_new'); ?>
	</button>
</div>
...
<div id="report_summary">
	...
	<div class="summary_row"><?php echo 'Total '.$this->lang->line('costs_cash_currency') . ': ' .to_currency((!empty($cost_summary->cash_amount) ? $cost_summary->cash_amount : 0)); ?></div>
	<hr>
	<div class="summary_row"><?php echo 'Total '.$this->lang->line('costs_bank_currency') . ': ' .to_currency((!empty($cost_summary->check_amount) ? $cost_summary->check_amount : 0)); ?></div>
</div>
