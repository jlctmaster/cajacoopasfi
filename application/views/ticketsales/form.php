...
<?php echo form_open('ticketsales/'.$action.'/'.$ticketsale_info->ticketsale_id, array('id'=>'ticketsale_edit_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="ticketsales">
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_documentdate'), 'documentdate', array('class'=>'required control-label col-xs-2')); ?>
			<div class='col-xs-4'>
				<div class="input-group">
					...
					<?php echo form_input(array(
							...
							'value'=>to_datetime(strtotime($ticketsale_info->documentdate)))
							); ?>
				</div>
			</div>
			<div class='col-xs-6'>
				<?php echo form_label($this->lang->line('ticketsales_serieno'), 'serieno', array('class'=>'required control-label col-xs-3')); ?>
				<div class='col-xs-8'>
					<?php echo form_input(array(
							'name'=>'serieno',
							'id'=>'serieno',
							'class'=>'form-control input-sm',
							'value'=>$ticketsale_info->serieno)
							);?>
				</div>
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-4'>
				<?php echo form_input(array(
						...
						'id'=>'person_id',
						'type'=>'hidden',
						'value'=>$ticketsale_info->person_id)
						);?>
				<?php echo form_input(array(
						'name'=>'cashup_id',
						'id'=>'cashup_id',
				...
				<?php echo form_input(array(
						...
						'id'=>'person',
						'class'=>'form-control input-sm',
						'value'=>$ticketsale_info->name,
						'placeholder' => $this->lang->line('common_search_dni'))
						);?>
			</div>
			<div class='col-xs-6'>
				<?php echo form_label($this->lang->line('ticketsales_documentno'), 'documentno', array('class'=>'required control-label col-xs-3')); ?>
				<div class='col-xs-8'>
					<?php if($this->config->item('ticketsale_number_automatic') == '1')
				{
					echo form_input(array(
						...
						'class'=>'form-control input-sm',
						'readonly' => TRUE,
						'value'=>$ticketsale_info->documentno)
						);
				}
				else
				{
		...
		<div class="form-group form-group-sm">	
			<?php echo form_label($this->lang->line('ticketsales_description'), 'description', array('class'=>'control-label col-xs-2')); ?>
			<div class='col-xs-8'>
				<?php echo form_textarea(array(
						'name'=>'description',
						'id'=>'description',
						'class'=>'form-control input-sm',
						'value'=>$ticketsale_info->description)
						);?>
			</div>
		</div>

		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_add_lines'), 'details', array('class'=>'required control-label col-xs-6')); ?>
			<div class='col-xs-12'>
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							<td><?php echo $this->lang->line('ticketsales_quantity')?></td>
							<td><?php echo $this->lang->line('ticketsales_detail')?></td>
							<td><?php echo $this->lang->line('ticketsales_price')?></td>
							<td><?php echo $this->lang->line('ticketsales_amount')?></td>
					...
					<tbody id="item_details">
						<?php if(!empty($lineticketsale_info[0]->lineticketsale_id)):
							$contador = 0; ?>
						<?php 	foreach ($lineticketsale_info as $detail_info):?>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_subtotal'), 'subtotal', array('class'=>'required control-label col-xs-8')); ?>
			<div class='col-xs-3'>
				<?php echo form_input(array(
						'name'=>'subtotal',
						'id'=>'subtotal',
						...
						'type' => 'number',
						'readonly' => TRUE,
						'value'=>$ticketsale_info->totalamt)
						);?>
			</div>
		</div>

		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_discount'), 'discount', array('class'=>'required control-label col-xs-8')); ?>
			<div class='col-xs-3'>
				<?php echo form_input(array(
						'name'=>'discount',
						'id'=>'discount',
						...
						'step' => 0.01,
						'max' => 100,
						'value'=>$ticketsale_info->discount)
						);?>
				<?php echo form_input(array(
						'name'=>'discountamt',
						'id'=>'discountamt',
						...
						'type' => 'hidden',
						'readonly' => TRUE,
						'value'=>$ticketsale_info->discountamt)
						);?>
			</div>
		</div>

		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_totalamt'), 'totalamt', array('class'=>'required control-label col-xs-8')); ?>
			<div class='col-xs-3'>
				<?php echo form_input(array(
						'name'=>'totalamt',
						'id'=>'totalamt',
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('ticketsales_paymentterm'), 'movementtype', !empty($basic_version) ? array('class'=>'required control-label col-xs-3') : array('class'=>'control-label col-xs-3')); ?>
			<div class="col-xs-8">
				<label class="radio-inline">
					<?php echo form_radio(array(
							...
							'id'=>'cash_typeC',
							'value'=>'C',
							'checked'=>(!empty($ticketsale_info->movementtype) ? ($ticketsale_info->movementtype === 'C') : TRUE ))
				...
				<label class="radio-inline">
					<?php echo form_radio(array(
							...
							'id'=>'cash_typeB',
							'value'=>'B',
							'checked'=>$ticketsale_info->movementtype === 'B')
		...
		<div class="form-group form-group-sm" id="movementtype_bank_trx" style="display:none">
			<?php echo form_label($this->lang->line('ticketsales_trx_number'), 'trx_number', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_input(array(
						'name'=>'trx_number',
						'id'=>'trx_number',
						'class'=>'form-control input-sm',
						'value'=>$ticketsale_info->trx_number)
						);?>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function elimina_me(elemento){
		...
		var totalamt = (parseFloat(subtotal)-parseFloat(discountamt)).toFixed(2);
...
$(document).ready(function()
{
	...
	<?php if($readonlyform): ?>
		$("#ticketsale_edit_form :input").prop("disabled", true);
	<?php endif;?>
	...
	$("#person").autocomplete({
		source: "<?php echo site_url('ticketsales/suggest_person');?>",
		delay: 10,
	...
	$('#ticketsale_edit_form').validate($.extend({
		...
		rules:
		{
			<?php if($this->config->item('ticketsale_number_automatic') == '0'):?>
				documentno: 'required',
			<?php endif;?>
		...
		{
			<?php if($this->config->item('ticketsale_number_automatic') == '0'):?>
				documentno: "<?php echo $this->lang->line('ticketsale_documentno_required'); ?>",
			<?php endif;?>
			documentdate: "<?php echo $this->lang->line('ticketsale_documentdate_required'); ?>",
			serieno: "<?php echo $this->lang->line('ticketsale_serieno_required'); ?>",
			person: "<?php echo $this->lang->line('ticketsale_name_required'); ?>",
			totalamt: "<?php echo $this->lang->line('ticketsale_total_required'); ?>",
			trx_number: "<?php echo $this->lang->line('ticketsale_trx_number_required'); ?>"
		}
	}, form_support.error));
});
</script>
