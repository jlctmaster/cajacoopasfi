<?php echo form_open('config/save_locale/', array('id' => 'locale_config_form', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_currency_usd_conversion'), 'currency_usd_conversion', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_input(array(
						'name' => 'currency_usd_conversion',
						'id' => 'currency_usd_conversion',
						'class' => 'form-control input-sm number_locale',
						'type' => 'number',
						'step' => 0.01,
						'value'=>$this->config->item('currency_usd_conversion'))); ?>
				</div>
			</div>
