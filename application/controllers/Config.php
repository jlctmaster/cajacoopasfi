...
class Config extends Secure_Controller
{
	...
	*/
	private function _licenses()
	{
		...
		$license[$i]['title'] = 'Input & Output Materials Management ' . $this->config->item('application_version');
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in IOMSystem license directory. You are not allowed to use IOMSystem application until the distribution copy of LICENSE file is present.';
		}
	...
	*/
	...
	public function save_locale()
	{
		...
		$batch_save_data = array(
			...
			'currency_usd_conversion' => $this->input->post('currency_usd_conversion')
		);
	...
	*/
	...
	public function backup_db()
	{
		...
		if($this->User->has_module_grant('config', $user_id))
		{
			$this->load->dbutil();

			$prefs = array(
				'format' => 'zip',
				'filename' => 'cajacoopafsidb.sql',
				'foreign_key_checks' => FALSE
			);

			$backup = $this->dbutil->backup($prefs);

			$file_name = 'cajacoopafsidb-' . date("Y-m-d-H-i-s") .'.zip';
	...
	public function save_cashjournal()
	{
		...
		$batch_save_data = array(
			'adjustnote_number_automatic' => $this->input->post('adjustnote_number_automatic') != NULL,
			'adjustnote_doctype_sequence' => $this->input->post('adjustnote_doctype_sequence'),
			...
			'creditnote_number_automatic' => $this->input->post('creditnote_number_automatic') != NULL,
			'creditnote_doctype_sequence' => $this->input->post('creditnote_doctype_sequence'),
			...
			'invoice_number_automatic' => $this->input->post('invoice_number_automatic') != NULL,
			'invoice_doctype_sequence' => $this->input->post('invoice_doctype_sequence'),
			'ticketsale_number_automatic' => $this->input->post('ticketsale_number_automatic') != NULL,
			'ticketsale_doctype_sequence' => $this->input->post('ticketsale_doctype_sequence'),
			'voucher_number_automatic' => $this->input->post('voucher_number_automatic') != NULL,
			'voucher_doctype_sequence' => $this->input->post('voucher_doctype_sequence')
		);
