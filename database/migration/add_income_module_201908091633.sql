...
ALTER TABLE `iom_overall_cashs` 
	ADD `usdstartbalance` DECIMAL(10,2) NOT NULL DEFAULT '0' AFTER `endingbalance`, 
		ADD `usdopeningbalance` DECIMAL(10,2) NOT NULL DEFAULT '0' AFTER `usdstartbalance`, 
		ADD `usdendingbalance` DECIMAL(10,2) NOT NULL DEFAULT '0' AFTER `usdopeningbalance`;

ALTER TABLE `iom_cash_flow` 
	ADD `currency` CHAR(3) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'PEN' AFTER `description`;